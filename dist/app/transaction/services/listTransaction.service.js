...
🚩 @uses : get user transaction list
🗓 @created : 23/05/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getUserTransactionList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield transaction_repo_1.default.getAllUsersTransaction(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield transaction_repo_1.default.getAllUsersTransaction(container, 'transactionData');
        }
        else {
...
exports.default = getUserTransactionList;
//# sourceMappingURL=listTransaction.service.js.map