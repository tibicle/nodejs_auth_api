...
🚩 @uses : get font details service
🗓 @created : 19/03/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getFontList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield font_repo_1.default.getAllFontData(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //  Get the font data
            //
            container.output.result = yield font_repo_1.default.getAllFontData(container, 'fontData');
        }
        else {
...
//# sourceMappingURL=listFont.service.js.map