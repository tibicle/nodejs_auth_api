...
🚩 @uses : update font status service
🗓 @created : 19/03/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const updateFontStatus = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        container.output.message = i18n_1.default.__('font.status_update');
        return container;
    }
    catch (error) {
        throw error;
...
const updateStatus = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //  update the font status
        //
        yield font_repo_1.default.updateFontDetails(params.uuid, updateStatusDataModel);
        return container;
    }
    catch (error) {
        throw error;
...
exports.default = updateFontStatus;
//# sourceMappingURL=updateFontStatus.service.js.map