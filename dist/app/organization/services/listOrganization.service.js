...
🚩 @uses : list organization details service
🗓 @created : 05/03/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const listOrganizationDetailsService = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield organization_repo_1.default.getOrganizationData(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield organization_repo_1.default.getOrganizationData(container, 'organizationData');
        }
        else {
...
exports.default = listOrganizationDetailsService;
//# sourceMappingURL=listOrganization.service.js.map