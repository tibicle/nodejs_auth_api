...
🚩 @uses : get user module details service
🗓 @created : 28/06/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getUserModuleList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield academy_repo_1.default.getAllUserModuleData(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield academy_repo_1.default.getAllUserModuleData(container, 'userModuleData');
        }
        else {
...
exports.default = getUserModuleList;
//# sourceMappingURL=getUserModuleList.service.js.map