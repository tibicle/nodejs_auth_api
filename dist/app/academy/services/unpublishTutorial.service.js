...
🚩 @uses : unpublish tutorial service
🗓 @created : 15/05/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const unpublishTutorialService = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //  unpublish tutorial
        //
        yield unpublishTutorial(container);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const unpublishTutorial = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { input: { body, params, logged_in_user, } } = container;
        //
...
exports.default = unpublishTutorialService;
//# sourceMappingURL=unpublishTutorial.service.js.map