...
const updateTutorialService = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //
        yield academy_repo_1.default.checkTutorialByUuid(body.tutorial_uuid);
        //
        //  check the title
        //
        const tutorial = yield academy_repo_1.default.checkTitle(body.title);
        if (tutorial && body.tutorial_uuid == tutorial.uuid) {
            if (tutorial.created_by != logged_in_user.uuid) {
...
const updateTutorialData = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //  update tutorial data
        //
        yield academy_repo_1.default.updateTutorialDetails(body.tutorial_uuid, updateTutorialDataModel);
        return container;
    }
    catch (error) {
        throw error;
