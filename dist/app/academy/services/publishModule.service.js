...
🚩 @uses : publish module service
🗓 @created : 29/05/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const publishModuleService = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const publishModule = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { input: { body, params, logged_in_user, } } = container;
        //
...
exports.default = publishModuleService;
//# sourceMappingURL=publishModule.service.js.map