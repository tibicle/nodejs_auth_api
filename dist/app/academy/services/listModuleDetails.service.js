...
🚩 @uses : get module details service
🗓 @created : 29/05/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getModuleList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield academy_repo_1.default.getAllModuleData(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield academy_repo_1.default.getAllModuleData(container, 'moduleData');
        }
        else {
...
//# sourceMappingURL=listModuleDetails.service.js.map