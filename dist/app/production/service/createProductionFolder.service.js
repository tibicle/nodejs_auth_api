...
🚩 @uses : create production folder into s3 bucket
🗓 @created : 26/03/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const createProductionFolder = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { input: { body, params, query, logged_in_user }, derived: { productionData } } = container;
        if (body.company_uuid) {
            //
            //  check company exists or not
            //
            const companyDetails = yield company_repos_1.default.checkCompanyExists(body.company_uuid);
...
exports.default = createProductionFolder;
//# sourceMappingURL=createProductionFolder.service.js.map