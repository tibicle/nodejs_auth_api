...
🚩 @uses : get user subscription list
🗓 @created : 23/05/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getUserSubscriptionList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield subscription_repo_1.default.getAllUsersSubscription(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield subscription_repo_1.default.getAllUsersSubscription(container, 'subscriptionData');
        }
        else {
...
exports.default = getUserSubscriptionList;
//# sourceMappingURL=listAllUsersSubscription.service.js.map