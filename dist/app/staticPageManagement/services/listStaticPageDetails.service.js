...
🚩 @uses : get static page details service
🗓 @created : 04/03/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getStaticPageList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield staticPage_repo_1.default.getAllStaticPageData(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield staticPage_repo_1.default.getAllStaticPageData(container, 'staticPageData');
        }
        else {
...
exports.default = getStaticPageList;
//# sourceMappingURL=listStaticPageDetails.service.js.map