...
🚩 @uses : get tutorial details service
🗓 @created : 01/03/2024
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const getTutorialList = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield tutorial_repo_1.default.getAllTutorialData(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            //
            container.output.result = yield tutorial_repo_1.default.getAllTutorialData(container, 'tutorialData');
        }
        else {
...
exports.default = getTutorialList;
//# sourceMappingURL=listTutorialDetails.service.js.map