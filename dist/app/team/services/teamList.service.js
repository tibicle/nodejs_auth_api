...
🚩 @uses : get team list service
🗓 @created : 22/11/2023
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
const teamListService = (container) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (container.input.query && ('page' in container.input.query)) {
            container.output.meta.total_rows = yield team_repo_1.default.getAllteamList(container, 'CountTotalData');
        ...
        if ((container.output.meta.total_rows > 0 && isPagination) || !isPagination) {
            ...
            // Get the team List
            //
            container.output.result = yield team_repo_1.default.getAllteamList(container, 'teamList');
        }
        else {
...
exports.default = teamListService;
//# sourceMappingURL=teamList.service.js.map